...
//				}
//				//ICI DRAPEAU
//				PageComputer pageComputer = new PageComputer(numberOfComputers, pageComputerNumber, computerService.list(numberOfComputers, pageComputerNumber) );
...
//					System.out.print(((Computer) pageComputer.getListComputers().get(i)).getId());
//					System.out.print(((Computer) pageComputer.getListComputers().get(i)).getName());
//					System.out.print(" "+((Computer) pageComputer.getListCs().get(i)).getIntroduced());				
//					System.out.println();
//				}
//				break;
//
...
//				}
//				//ICI DRAPEAU
//				PageComputer pageCompany = new PageComputer(numberOfCompanies, pageCompanyNumber, (x,y) -> companyService.list(x, y));
